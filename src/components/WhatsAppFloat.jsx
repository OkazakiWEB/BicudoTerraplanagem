...
export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full flex items-center justify-center shadow-[0_4px_24px_rgba(37,211,102,0.45)] transition-all duration-200 hover:scale-110 hover:shadow-[0_8px_32px_rgba(37,211,102,0.55)]"
